...
#
# Writes: dist/kartia-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix kartia \
  --exe-name Kartia_The_Word_of_Fate \
  --omit-openbios \
  --display-name "Kartia: The Word of Fate" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned Kartia: The Word of Fate (USA) disc" \
  --runtime-dir mods \
