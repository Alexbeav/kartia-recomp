...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Kartia: The Word of Fate",
    .project_root_env = "KARTIA_THE_WORD_OF_FATE_PROJECT_ROOT",
    .build_dir_env = "KARTIA_THE_WORD_OF_FATE_BUILD_DIR",
    .force_setup_env = "KARTIA_THE_WORD_OF_FATE_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_006.31_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Kartia_The_Word_of_Fate",
    .prepare_note =
